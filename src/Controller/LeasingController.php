...
class LeasingController extends AbstractController
{
     ...
     */
    public function showLocation(Request $request , Vehicle $vehicle, ObjectManager $em, DateRepository $dateRepository, \Swift_Mailer $mailer)
    {
        $dates = $dateRepository->getAvailableDates($vehicle);
